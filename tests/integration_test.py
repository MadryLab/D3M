...
def get_dataloader(batch_size=128, num_workers=5, split='train', shuffle=False, augment=True):
    if augment:
...
group_inds = [np.random.choice(4) for i in range(len(train_loader.dataset))]
